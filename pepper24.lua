...
function scene:createScene( event )
	...
	level = display.newText("Level 24",30,10,'marker felt', 20)
	group:insert(level)
  ...
  cupC.anchorY = 1
	...
	lineL3 = display.newRect(16, h/2-50, 55, 2  )
	lineL3.rotation= 100
	...
	lineR3 = display.newRect( 60, h/2-50, 58, 2  )
	lineR3.rotation= 80
  ...
  cupB.anchorY = 1
	...
	lineR2 = display.newRect(w-50+ad, h/2-50, 58, 2  )
	lineR2.name = "linet"
	lineR2.rotation= 80
	...
	bluBack = display.newRect(w/2,h/2-90, 50, 7) 
	...
	greenBack = display.newRect(w/2 ,h/2+50, 50, 7) 
  ...
  cupA.anchorY = 1
	...
	lineR1 = display.newRect( 94+ad, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupD.anchorY = 1
	...
	lineTD = display.newRect( w-64,h-55, 39, 3)
	lineTD.name = "lineTD"
	...
	lineLD = display.newRect(w-86, h-20, 70, 1 )
	lineLD.rotation= 80
	...
	lineRD = display.newRect(w-76+ad, h-20, 70, 1 )
	lineRD.rotation= -80
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint24.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 200 then
				storyboard.star = 3
        		print ("3star")
        		myStars24:store('stars24',13)
        		myStars24:save()
    	elseif j < 250 then
    			storyboard.star = 2
        		print ("2star")
        		myStars24:store('stars24',12)
        		myStars24:save()
    	elseif j < 300 then
    			storyboard.star = 1
        		print ("1star")
        		myStars24:store('stars24',11)
        		myStars24:save()
    end
    z=1
