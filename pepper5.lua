...
function scene:createScene( event )
	...
	if (storyboard.music == 1) then
		audio.play(songA, {channel = 12, loops =2})
	end
	...
	level = display.newText("Level 5",40,10,'marker felt', 20)
	group:insert(level)
	...
	bluBack = display.newRect(-20,240, 120, 7) 
	...
	lineT2 = display.newRect(cupB.x +27,cupB.y-55, 40, 1)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect(cupB.x+3,cupB.y -25, 55, 1  )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	text3 = display.newText("Red Ball-",w-70,150,'marker felt',25)
text3:setTextColor(250,0,0)
group:insert(text3)
		
text4 = display.newText("Red Cup.",w-70,172,'marker felt',25)
text4:setTextColor(250,0,0)
group:insert(text4)
	
	text1 = display.newText("Purple Ball-",w-70,210,'marker felt',25)
text1:setTextColor(200,0,200)
group:insert(text1)
		
text2 = display.newText("Purple Cup.",w-70,232,'marker felt',25)
text2:setTextColor(200,0,200)
group:insert(text2)
	...
	group:insert(myButton1)
     ...
     function removeHints(event)
     	...
     	function hintButton1()
     		hhints2 = display.newImageRect('hint5.png',w ,h)
			hhints2.x = w - w/2
			hhints2.y = h - h/2
...
function transitionA()
	if j < 75 then
				storyboard.star = 3
        		print ("3star")
        		myStars5:store('stars5',13)
        		myStars5:save()
    	elseif j < 100 then
    			storyboard.star = 2
        		print ("2star")
        		myStars5:store('stars5',12)
        		myStars5:save()
    	elseif j < 125 then
    			storyboard.star = 1
        		print ("1star")
        		myStars5:store('stars5',11)
        		myStars5:save()
    end
    z=1
