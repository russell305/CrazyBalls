...
function scene:createScene( event )
	...
	level = display.newText("Level 4",40,10,'marker felt', 20)
	group:insert(level)
  ...
  lineT3 = display.newRect( cupC.x +28,cupC.y -40, 39, 1)
  lineT3.name = "lineT3"
  ...
  lineL3 = display.newRect(cupC.x+6 ,cupC.y -67, 55, 2  )
  lineL3.rotation= 100
  ...
  lineR3 = display.newRect(cupC.x +50 ,cupC.y -67, 55, 2  )
  lineR3.rotation= 80
  ...
  lineR3.alpha = 0 --this is if you want the line to be invisble
	...
	text1 = display.newText("Use gravity",w-100,160,'marker felt',20)
text1:setTextColor(250,250,250)
group:insert(text1)

text4 = display.newText("Button",w-100,180,'marker felt',20)
text4:setTextColor(250,250,250)
group:insert(text4)
		
text2 = display.newText("To change",w-100,200,'marker felt',20)
text2:setTextColor(250,250,250)
group:insert(text2)

text3 = display.newText("Direction.",w-100,220,'marker felt',20)
text3:setTextColor(250,250,250)
group:insert(text3)

text4 = display.newText("Double Bouncy",w-100,h-50,'marker felt',20)
text4:setTextColor(250,250,250)
group:insert(text4)

  dash = display.newImageRect('dashC.png',w/2 ,h/4)
  dash.alpha = .5
  dash.x = cupC.x+125
  dash.y = cupC.y+20
  group:insert(dash)

    dash2 = display.newImageRect('dashB.png',w/4 ,h/4)
  dash2.alpha = .5
  dash2.x = w/2
  dash2.y = h-70
  group:insert(dash2)
 ...
 onButtonEvent = function (event )
  ...
  function removeHints(event)
      ...
      function hintButton1()
        hhints2 = display.newImageRect('hint4.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 65 then
				storyboard.star = 3
        		print ("3star")
        		myStars4:store('stars4',13)
        		myStars4:save()
    	elseif j < 85 then
    			storyboard.star = 2
        		print ("2star")
        		myStars4:store('stars4',12)
        		myStars4:save()
    	elseif j < 105 then
    			storyboard.star = 1
        		print ("1star")
        		myStars4:store('stars4',11)
        		myStars4:save()
    end
    z=1
