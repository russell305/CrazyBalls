...
function scene:createScene( event )
	...
	level = display.newText("Level 26",30,10,'marker felt', 20)
	group:insert(level)
	...
	bluBack = display.newRect(20,240, 50, 5) 
	...
	redBack = display.newRect(w/2-70,240, 50, 5) 
	...
	tealBack = display.newRect(w/2,240, 50, 5) 
	...
	purpleBack = display.newRect(w-20,240, 50, 5) 
  ...
  cupC.anchorY = 1
	...
	lineT3 = display.newRect(cupC.x +30,cupC.y-55, 40, 1)
	lineT3.name = "lineT3"
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint26.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 220 then
				storyboard.star = 3
        		print ("3star")
        		myStars26:store('stars26',13)
        		myStars26:save()
    	elseif j < 250 then
    			storyboard.star = 2
        		print ("2star")
        		myStars26:store('stars26',12)
        		myStars26:save()
    	elseif j < 280 then
    			storyboard.star = 1
        		print ("1star")
        		myStars26:store('stars26',11)
        		myStars26:save()
    end
    z=1
