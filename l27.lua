...
function scene:enterScene( event )
	...
	local stars27 = myStars27:retrieve('stars27') 
		
		if (stars27 == 13) then
			l27 = display.newImageRect('Stars/3-Stars-27.png',55,55)
			
		elseif (stars27 == 12) then
			l27 = display.newImageRect('Stars/2-Stars-27.png',55,55)
		elseif (stars27 == 11) then 
			l27= display.newImageRect('Stars/1-Stars-27.png',55,55)
		else	
			l27 = display.newImageRect('Stars/Unlocked-27.png',55,55)
		end
	
	l27:addEventListener('tap', onTap27)
	l27.x = w/2+95
	l27.y = 100
	group:insert(l27)
