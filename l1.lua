...
local lock, l16, l17, l18, l19, l20, l21, l22, l23, l24, l25, text1
...
function scene:createScene( event )
	...
	group:insert(bg1)
	--[[
	local text1 = display.newText('Fun with Crazy Balls', 14,  h/2,'GROBOLD', 30)
	text1:setTextColor (255,185,0)
	group:insert(text1)
	--]]
...
function scene:enterScene( event )
	...
	l1 = display.newImageRect('Stars/Unlocked-1.png' ,55,55)
	l1.x = w/2-95
	l1.y = 40
	...
	l2 = display.newImageRect('Stars/Locked-2.png',55,55)
	l2.x = w/2+5
	l2.y = 40
	group:insert(l2)
	
	
	l3 = display.newImageRect('Stars/Locked-3.png',55,55)
	l3.x = w/2+105
	l3.y = 40
	group:insert(l3)
	
	l4 = display.newImageRect('Stars/Locked-4.png',55,55)
	l4.x = w/2-95
	l4.y = 100
	group:insert(l4)
