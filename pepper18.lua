...
function scene:createScene( event )
	...
	level = display.newText("Level 18",30,10,'marker felt', 20)
	group:insert(level)
  ...
  group:insert(floor1)
	...
	bluBack = display.newRect(w-60,h-240, 75, 7) 
  ...
  cupC.anchorY = 1
	...
	lineT3 = display.newRect( 36,h/2+20, 49, 3)
	lineT3.name = "lineT3"
	...
	lineL3 = display.newRect(15, h/2+48, 65, 1  )
	lineL3.name = "lineL3"
	lineL3.rotation= 80
	...
	lineR3 = display.newRect( 64, h/2+48, 65, 1  )
	lineR3.rotation= -80
...
if (storyboard.level >= levels) then
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint18.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function removeHints()
	...
	if j < 90 then
				storyboard.star = 3
        		print ("3star")
        		myStars18:store('stars18',13)
        		myStars18:save()
    	elseif j < 110 then
    			storyboard.star = 2
        		print ("2star")
        		myStars18:store('stars18',12)
        		myStars18:save()
    	elseif j < 130 then
    			storyboard.star = 1
        		print ("1star")
  ...
  function createBall()
    ...
    ball[j] = display.newImageRect("ballW.png", 20, 20)
    ball[j].x = ranX
    ball[j].y = 40
