...
function scene:createScene( event )
	...
	level = display.newText("Level 21",30,10,'marker felt', 20)
	group:insert(level)
	...
	bluBack = display.newRect(87,200+offset, 60, 5) 
  ...
  bluBack.anchorY = 1
	...
	redBack = display.newRect(173,200+offset, 60, 5) 
  ...
  redBack.anchorY = 1
	...
	tealBack = display.newRect(w-60,200+offset, 60, 5) 
  ...
  tealBack.anchorY = 1
	...
	yellowBack = display.newRect(0,200+offset, 60, 5) 
	yellowBack.name = "yellowBack"
	yellowBack.anchorX = -1
  yellowBack.anchorY = 1
  ...
  cupY.anchorY = 1
	...
	lineTy = display.newRect( 113,h-55, 39, 3)
	lineTy.name = "lineTy"
	...
	lineLy = display.newRect(88, h-20, 70, 1  )
	lineLy.name = "lineLy"
	lineLy.rotation= 80
	...
	lineRy = display.newRect( 102+ad, h-20, 70, 1  )
	lineRy.name = "lineRy"
	lineRy.rotation= -80
  ...
  cupA.anchorY = 1
	...
	lineT1 = display.newRect( 208,h-55, 39, 3)
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(149+ad, h-20, 70, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 80
	...
	lineR1 = display.newRect( 197+ad, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupB.anchorY = 1
	...
	lineT2 = display.newRect( w/2+133,h-55, 39, 3)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect( w/2+74+ad, h-20, 70, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	lineR2 = display.newRect( w/2+122+ad, h-20, 70, 1 )
	lineR2.name = "linet"
	lineR2.rotation= -80
  ...
  cupC.anchorY = 1
	...
	gameScoreC = 25
	scoreTextC = display.newText(gameScore,0,0,"Arial", 15)
	scoreTextC:setTextColor(0,0,0)
	scoreTextC.x = 27
	scoreTextC.y = h-22
	group:insert(scoreTextC)
	
	lineT3 = display.newRect( 28,h-55, 39, 3)
	lineT3.name = "lineT3"
	...
	lineL3 = display.newRect(-31+ad, h-20, 70, 1  )
	lineL3.rotation= 80
	...
	lineR3 = display.newRect( 17+ad, h-20, 70, 1  )
	lineR3.rotation= -80
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint21.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 180 then
				storyboard.star = 3
        		print ("3star")
        		myStars21:store('stars21',13)
        		myStars21:save()
    	elseif j < 220 then
    			storyboard.star = 2
        		print ("2star")
        		myStars21:store('stars21',12)
        		myStars21:save()
    	elseif j < 260 then
    			storyboard.star = 1
        		print ("1star")
        		myStars21:store('stars21',11)
        		myStars21:save()
    end
    z=1
