...
function scene:createScene( event )
	...
	level = display.newText("Level 2",40,10,'marker felt', 15)
	group:insert(level)
	...
	dash = display.newImageRect('dash4.png',w/2 ,h/4)
	dash.alpha = .5
	dash.x = cupA.x+50
	dash.y = h-80
	group:insert(dash)
	...
	text1 = display.newText("Fill Both",w-100,h/2-20, 'marker felt',22)
text1:setTextColor(250,250,250)
--text1:setTextColor(200,200,0)
group:insert(text1)
		
text2 = display.newText("Cups with",w-100,h/2,'marker felt',22)
text2:setTextColor(250,250,250)
--text2:setTextColor(200,200,0)
group:insert(text2)

text3 = display.newText("15 Balls.",w-100,h/2+22,'marker felt',22)
...
function start()
 ...
 function menuButtons()   	
	...
	function removeHints(event)
     	...
     	function hintButton()
     		hhints2 = display.newImageRect('hint2.png',w ,h)
			hhints2.x = w - w/2
			hhints2.y = h - h/2
			...
			if (z == 0) then
        		audio.play(wee)	
						...
						if cupScore == 0 then
							...
							audio.play(win)
							cupText.alpha=0
							arrow2 = display.newImageRect('arrowL.png', 56, 32)
							arrow2.x = w/2-25
							arrow2.y = h-40
							group:insert(arrow2)
							if b==2 then
...
function transitionA()
	if j < 50 then
				storyboard.star = 3
        		print ("3star")
        		myStars2:store('stars2',13)
        		myStars2:save()
    	elseif j < 100 then
    			storyboard.star = 2
        		print ("2star")
        		myStars2:store('stars2',12)
        		myStars2:save()
    	elseif j < 150 then
    			storyboard.star = 1
        		print ("1star")
	...
	function createBall()
		...
		ball[j] = display.newImageRect("ballR.png", 15, 15)
		ball[j].x = ranX
		ball[j].y = 40
...
function callTimer()
	tmr1 = timer.performWithDelay( 400, createBall, 1490 )
end	
