...
function scene:createScene( event )
	...
	level = display.newText("Level 15",40,10,'marker felt', 15)
	group:insert(level)
	...
	stone = display.newImageRect('wood.png', w/2, 15)
  ...
  cupA.anchorY = 1
	...
	lineT1 = display.newRect( 114,h-55, 39, 3)
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(55+ad, h-20, 70, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 80
	...
	lineR1 = display.newRect( 99+ad, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupB.anchorY = 1
	...
	lineT2 = display.newRect( w/2+28,h-55, 39, 3)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect( w/2-31+ad, h-20, 70, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	lineR2 = display.newRect( w/2+17+ad, h-20, 70, 1 )
	lineR2.name = "linet"
	lineR2.rotation= -80
  ...
  cupC.anchorY = 1
	...
	lineL3 = display.newRect(-15+ad, h/2-50, 55, 2  )
	lineL3.rotation= 100
	...
	lineR3 = display.newRect(30+ad, h/2-50, 58, 2  )
	lineR3.rotation= 80
  ...
  cupD.anchorY = 1
	...
	lineLD = display.newRect(w-95+ad, h/2-50, 55, 2  )
	lineLD.rotation= 100
	...
	lineRD = display.newRect(w-50+ad, h/2-50, 58, 2  )
	lineRD.rotation= 80
...
function removeHints(event)
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint15.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 175 then
				storyboard.star = 3
        		print ("3star")
        		myStars15:store('stars15',13)
        		myStars15:save()
    	elseif j < 200 then
    			storyboard.star = 2
        		print ("2star")
        		myStars15:store('stars15',12)
        		myStars15:save()
    	elseif j < 225 then
    			storyboard.star = 1
        		print ("1star")
        		myStars15:store('stars15',11)
        		myStars15:save()
    end
    z=1
