...
function scene:createScene( event )
	...
	level = display.newText("Level 23",30,10,'marker felt', 20)
	group:insert(level)
	...
	bluBack = display.newRect(0,240, 60, 5) 
  ...
  bluBack.anchorY = 1
	...
	redBack = display.newRect(87,240, 60, 5) 
  ...
  redBack.anchorY = 1
	...
	tealBack = display.newRect(173,240, 60, 5) 
  ...
  tealBack.anchorY = 1
	...
	yellowBack = display.newRect(w-60,240, 60, 5) 
  ...
  cupY.anchorY = 1
	...
	lineRy = display.newRect( 136, h-20, 70, 1  )
	lineRy.name = "lineRy"
	lineRy.rotation= -80
  ...
  cupA.anchorY = 1
	...
	lineL1 = display.newRect(183, h-20, 70, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 80
	...
	lineR1 = display.newRect( 231, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupB.anchorY = 1
	...
	lineL2 = display.newRect( w/2+108, h-20, 70, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	lineR2 = display.newRect( w/2+156, h-20, 70, 1 )
	lineR2.name = "linet"
	lineR2.rotation= -80
  ...
  cupC.anchorY = 1
	...
	lineL3 = display.newRect(3, h-20, 70, 1  )
	lineL3.rotation= 80
	...
	lineR3 = display.newRect( 51, h-20, 70, 1  )
	lineR3.rotation= -80
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint23.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 225 then
				storyboard.star = 3
        		print ("3star")
        		myStars23:store('stars23',13)
        		myStars23:save()
    	elseif j < 250 then
    			storyboard.star = 2
        		print ("2star")
        		myStars23:store('stars23',12)
        		myStars23:save()
    	elseif j < 275 then
    			storyboard.star = 1
        		print ("1star")
        		myStars23:store('stars23',11)
        		myStars23:save()
    end
    z=1
