...
function scene:createScene( event )
	...
	level = display.newText("Level 8" ,40,10,'marker felt', 15)
	group:insert(level)
  ...
  cupA.anchorY = 1
	...
	lineT1 = display.newRect( 70,h-55, 39, 3)
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(44, h-20, 70, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 80
	...
	lineR1 = display.newRect( 92, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupB.anchorY = 1
	...
	lineT2 = display.newRect( w/2+70,h-55, 39, 3)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect( w/2+44, h-20, 70, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	lineR2 = display.newRect( w/2+92, h-20, 70, 1 )
	lineR2.name = "linet"
	lineR2.rotation= -80
...
function removeHints(event)
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint8.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 75 then
				storyboard.star = 3
        		print ("3star")
        		myStars8:store('stars8',13)
        		myStars8:save()
    	elseif j < 100 then
    			storyboard.star = 2
        		print ("2star")
        		myStars8:store('stars8',12)
        		myStars8:save()
    	elseif j < 125 then
    			storyboard.star = 1
        		print ("1star")
        		myStars8:store('stars8',11)
        		myStars8:save()
            else 
            storyboard.star = 0
            print ("0star")   
