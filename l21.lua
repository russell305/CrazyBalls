...
function scene:enterScene( event )
	...
	storyboard.removeScene('tapBack')
...
local function ballSetup()
	...
	local stars18 = myStars18:retrieve('stars18') 
		
		if (stars18 == 13) then
			l18 = display.newImageRect('Stars/3-Stars-18.png',55,55)
			
		elseif (stars18 == 12) then
			l18 = display.newImageRect('Stars/2-Stars-18.png',55,55)
		else 
			l18= display.newImageRect('Stars/1-Stars-18.png',55,55)
	...
	local stars19 = myStars19:retrieve('stars19') 
		
		if (stars19 == 13) then
			l19 = display.newImageRect('Stars/3-Stars-19.png',55,55)
			
		elseif (stars19 == 12) then
			l19 = display.newImageRect('Stars/2-Stars-19.png',55,55)
		else 
			l19= display.newImageRect('Stars/1-Stars-19.png',55,55)
			
		end
	l19.x = w/2-95
	l19.y = 400
	l19:addEventListener('tap', onTap19)
	group:insert(l19)
	
	local stars20 = myStars20:retrieve('stars20') 
		
		if (stars20 == 13) then
			l20 = display.newImageRect('Stars/3-Stars-20.png',55,55)
			
		elseif (stars20 == 12) then
			l20 = display.newImageRect('Stars/2-Stars-20.png',55,55)
		else 
			l20= display.newImageRect('Stars/1-Stars-20.png',55,55)
			
		end
	l20.x = w/2+5
	l20.y = 400
	l20:addEventListener('tap', onTap20)
	group:insert(l20)
	
	local stars21 = myStars21:retrieve('stars21') 
		
		if (stars21 == 13) then
			l21 = display.newImageRect('Stars/3-Stars-21.png',55,55)
			
		elseif (stars21 == 12) then
			l21 = display.newImageRect('Stars/2-Stars-21.png',55,55)
		elseif (stars21 == 11) then
			l21= display.newImageRect('Stars/1-Stars-21.png',55,55)
		else	
			l21 = display.newImageRect('Stars/Unlocked-21.png',55,55)
		end
	
	--l21 = display.newImageRect('Stars/Unlocked-21.png',55,55)
	l21.x =  w/2+105
	l21.y =  400
	l21:addEventListener('tap', onTap21)
	group:insert(l21)
	...
	ll = display.newImageRect('arrowR.png',50,50)
	ll.x = w/2+104
	ll.y = 455
	ll:addEventListener('tap', onTapNext)
	group:insert(ll)
