...
if (storyboard.music == 1) then
  ...
  group:insert(floor1)
	...
	bluBack = display.newRect(w/2-60,210, 75, 7) 
  ...
  cupA.anchorY = 1
	...
	lineT1 = display.newRect( 83+20,h-55, 39, 3)
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(44+ad, h-20, 70, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 80
	...
	lineR1 = display.newRect( 92+ad, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
...
if (storyboard.level >= levels) then
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint12.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
