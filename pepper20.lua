...
function scene:createScene( event )
	...
	if (storyboard.music == 1) then
		audio.play(song2, {channel = 12, loops =1})
	end
	...
	level = display.newText("Level 20",40,10,'marker felt', 15)
	group:insert(level)
  ...
  cupA.anchorY = 1
	...
	lineT1 = display.newRect( 112,h-90, 42, 1)
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(92, h-116, 55, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 100
	...
	lineR1 = display.newRect( 109+30, h-116, 55, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= 80
  ...
  cupB.anchorY = 1
	...
	lineT2 = display.newRect( w/2+27,h-90, 42, 1)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect( w/2-22+30, h-116, 55, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 100
	...
	lineR2 = display.newRect( w/2+23+30, h-116, 55, 1 )
	lineR2.name = "linet"
	lineR2.rotation= 80
  ...
  cupC.anchorY = 1
	...
	lineL3 = display.newRect(20, h/2-50, 55, 2  )
	lineL3.rotation= 100
	...
	lineR3 = display.newRect( 64, h/2-50, 58, 2  )
	lineR3.rotation= 80
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint20.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 160 then
				storyboard.star = 3
        		print ("3star")
        		myStars20:store('stars20',13)
        		myStars20:save()
    	elseif j < 180 then
    			storyboard.star = 2
        		print ("2star")
        		myStars20:store('stars20',12)
        		myStars20:save()
    	elseif j < 200 then
    			storyboard.star = 1
        		print ("1star")
        		myStars20:store('stars20',11)
        		myStars20:save()
        		else 
        		storyboard.star = 0
        		print ("0star")		
