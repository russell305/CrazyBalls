...
function scene:createScene( event )
	...
	level = display.newText("Level 14",40,10,'marker felt', 15)
	group:insert(level)
  ...
  group:insert(floor1)
	...
	redBack = display.newRect(w/2-40,240, 75, 7) 
 ...
 redBack.anchorY = 1
	...
	bluBack = display.newRect(30,240, 75, 7) 
  ...
  bluBack.anchorY = 1
	...
	tealBack = display.newRect(w-110,240, 75, 7) 
 ...
 tealBack.anchorY = 1
  ...
  local ad = 34
	...
	lineT1 = display.newRect( 158,h-55, 39, 3)
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(99+ad, h-20, 70, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 80
	...
	lineR1 = display.newRect( 147+ad, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupB.anchorY = 1
	...
	lineT2 = display.newRect( w/2+103,h-55, 39, 3)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect( w/2+44+ad, h-20, 70, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	lineR2 = display.newRect( w/2+92+ad, h-20, 70, 1 )
	lineR2.name = "linet"
	lineR2.rotation= -80
  ...
  cupC.anchorY = 1
	...
	lineT3 = display.newRect( 48,h-55, 39, 3)
	lineT3.name = "lineT3"
	...
	lineL3 = display.newRect(-11+ad, h-20, 70, 1  )
	lineL3.rotation= 80
	...
	lineR3 = display.newRect( 37+ad, h-20, 70, 1  )
	lineR3.rotation= -80
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint14.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 115 then
				storyboard.star = 3
        		print ("3star")
        		myStars14:store('stars14',13)
        		myStars14:save()
    	elseif j < 135 then
    			storyboard.star = 2
        		print ("2star")
        		myStars14:store('stars14',12)
        		myStars14:save()
    	elseif j < 155 then
    			storyboard.star = 1
        		print ("1star")
        		myStars14:store('stars14',11)
        		myStars14:save()
    end
    z=1
