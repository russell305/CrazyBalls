...
function scene:createScene( event )
	...
	level = display.newText("Level 13",40,10,'marker felt', 15)
	group:insert(level)
	...
	redBack = display.newRect(30,240, 75, 7) 
  ...
  redBack.anchorY = -1
	...
	bluBack = display.newRect(w/2-40,240, 75, 7) 
  ...
  cupA.anchorY = 1
	...
	lineT1 = display.newRect( 138+20,h-55, 39, 3)
	lineT1.name = "lineT1"
...
function removeHints(event)
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint13.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
