...
function scene:createScene( event )
	...
	level = display.newText("Level 17",30,10,'marker felt', 20)
	group:insert(level)
  ...
  group:insert(floor1)
	...
	stone = display.newImageRect('wood.png', 220, 15)
  ...
  cupA.anchorY = 1
	...
	lineT1 = display.newRect( 105,h-57, 39, 3)
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(80, h-20, 70, 1  )
	lineL1.name = "lineL1"
	lineL1.rotation= 80
	...
	lineR1 = display.newRect( 126, h-20, 70, 1  )
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupB.anchorY = 1
	...
	lineT2 = display.newRect( w/2+105,h-57, 39, 3)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect( w/2+84, h-20, 70, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	lineR2 = display.newRect( w/2+126, h-20, 70, 1 )
	lineR2.name = "linet"
	lineR2.rotation= -80
	...
	stone2 = display.newImageRect('wood.png', 220, 15)
	
	stone2.x = 10
	stone2.y = h/2+7
	physics.addBody(stone2, "static",{bounce = 0.1, friction = .7} )
	group:insert(stone2)
	
	cupC = display.newImageRect('cupV.png', 70, 93)
	 cupC.anchorX = -1
  cupC.anchorY = 1
	cupC:setFillColor(255,185,0)
	cupC.x = 10
	cupC.y = h/2+100
	group:insert(cupC)
	...
	lineT3 = display.newRect( 38,h/2+56, 39, 3)
	lineT3.name = "lineT3"
	...
	lineL3 = display.newRect(17, h/2+30, 55, 2  )
	lineL3.rotation= 100
	...
	lineR3 = display.newRect( 64, h/2+30, 58, 2  )
	lineR3.rotation= 80
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint17.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 150 then
				storyboard.star = 3
        		print ("3star")
        		myStars17:store('stars17',13)
        		myStars17:save()
    	elseif j < 175 then
    			storyboard.star = 2
        		print ("2star")
        		myStars17:store('stars17',12)
        		myStars17:save()
    	elseif j < 200 then
    			storyboard.star = 1
        		print ("1star")
        		myStars17:store('stars17',11)
        		myStars17:save()
    end
    z=1
