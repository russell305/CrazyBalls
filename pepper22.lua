...
function scene:createScene( event )
	...
	level = display.newText("Level 22" ,30,10,'marker felt', 20)
	group:insert(level)
  ...
  wood.anchorY = 1
	...
	redBack = display.newRect(w/2-75/2,h/2-50, 65, 7) 
	redBack.name = "bluBack"
	redBack.anchorX = -1
  redBack.anchorY = 1
  ...
  cupD.anchorY = 1
	...
	lineRD = display.newRect(w-16, h/2-50, 58, 2  )
	lineRD.rotation= 80
...
function start()
   ...
   function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint22.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	...
	if j < 180 then
				storyboard.star = 3
        		print ("3star")
        		myStars22:store('stars22',13)
        		myStars22:save()
    	elseif j < 220 then
    			storyboard.star = 2
        		print ("2star")
        		myStars22:store('stars22',12)
        		myStars22:save()
    	elseif j < 260 then
    			storyboard.star = 1
        		print ("1star")
        		myStars22:store('stars22',11)
        		myStars22:save()
    end
    z=1
