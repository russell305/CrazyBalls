...
function scene:createScene( event )
	...
	level = display.newText("Level 10",40,10,'marker felt', 15)
	group:insert(level)
  ...
  group:insert(floor1)
	...
	bluBack = display.newRect(-10,h/2, 110, 7) 
  ...
  cupA.anchorY = 1
	...
	local adB =38
	lineT1 = display.newRect( 83,h-55, 39, 3)
  lineT1.anchorX = -1
	lineT1.name = "lineT1"
	...
	lineL1 = display.newRect(44+adB, h-20, 70, 1  )
	...
	lineR1 = display.newRect( 92+adB-4, h-20, 70, 1  )
 --lineR1.anchorX = -1
	lineR1.name = "lineR1"
	lineR1.rotation= -80
  ...
  cupB.anchorY = 1
	...
	lineT2 = display.newRect( w/2+83+20,h-55, 39, 3)
	lineT2.name = "lineT2"
	...
	lineL2 = display.newRect( w/2+44+adB, h-20, 70, 1 )
	lineL2.name = "line1"
	lineL2.rotation= 80
	...
	lineR2 = display.newRect( w/2+92+adB-4, h-20, 70, 1 )
	lineR2.name = "linet"
	lineR2.rotation= -80
  ...
  cupC.anchorY = 1
	...
	lineT3 = display.newRect( w-64+22,h/2-60, 42, 3)
	lineT3.name = "lineT3"
	...
	lineL3 = display.newRect(w-95+adB-4, h/2-32, 65, 1  )
	lineL3.name = "lineL3"
	lineL3.rotation= 80
	...
	lineR3 = display.newRect( w-50+adB-4, h/2-32, 65, 1  )
	lineR3.rotation= -80
...
if (storyboard.level >= levels) then
  ...
  function menuButtons()   	
    ...
    function hintButton1()
      hhints2 = display.newImageRect('hint10.png',w ,h)
      hhints2.x = w - w/2
      hhints2.y = h - h/2
...
function transitionA()
	if j < 110 then
				storyboard.star = 3
        		print ("3star")
        		myStars10:store('stars10',13)
        		myStars10:save()
    	elseif j < 130 then
    			storyboard.star = 2
        		print ("2star")
        		myStars10:store('stars10',12)
        		myStars10:save()
    	elseif j < 150 then
    			storyboard.star = 1
        		print ("1star")
        		myStars10:store('stars10',11)
        		myStars10:save()
    end
    z=1
